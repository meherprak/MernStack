        ...
        <main className="flex-grow flex flex-col items-center justify-center mt-8">
          ...
          <div className="mt-8 max-w-md w-full bg-white rounded-xl shadow-lg p-6 space-y-4">
            ...
            <p className="text-gray-600">
              Meher prakash is a passionate web developer with just about 0.03835616 years of experience in building dynamic and responsive web applications.
            </p>
            <p className="text-gray-600">Follow Meher on:</p>
            <ul className="flex space-x-4">
              ...
              <li>
                <a href="https://github.com/meherprak/" className="text-blue-500 hover:underline">GitHub</a>
              </li>
            </ul>
          </div>
        </main>
